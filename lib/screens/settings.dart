        ...
        return Column(
          children: <Widget>[
            ...
            AntList(
              ...
              children: [
                if (activeAccount.platform == PlatformType.github) ...[
                  AntListItem(
                  ...
                  AntListItem(
                    ...
                    extra: Text(activeAccount.login),
                    child:
                        Text(AppLocalizations.of(context)!.reviewPermissions),
                  ),
                ],
                if (activeAccount.platform == PlatformType.gitlab)
                  AntListItem(
                    onClick: () {
                      launchStringUrl('${activeAccount.domain}/help');
                    },
                    extra: FutureBuilder<String>(
                      future: fetchGitlab('/version').then((v) => v['version']),
                ...
                if (activeAccount.platform == PlatformType.gitea)
                  AntListItem(
                        ...
                        ActionItem(
                          ...
                          onTap: (_) async {
                            ...
                            if (res == true && theme.locale != key) {
                              ...
                              context.read<AuthModel>().reloadApp();
                            }
                          },
                        )
                    ]);
